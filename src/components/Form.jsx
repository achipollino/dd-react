            ...
            <form action="" method="post" className="order-form">
                <div className="form-group">
                    <input
                            ...
                            name="name"
                    />
                    <label for="name" className="form-label">Фамилия, Имя, Отчество</label>
                </div>
                <div className="form-group">
                    <input
                            type="text"
                            ...
                            name="university"
                    />
                    <label for="university" className="form-label">ВУЗ</label>
                </div>
                <div className="form-group">
                    <input
                            type="text"
                            ...
                            name="direction"
                    />
                    <label for="direction" className="form-label">Текущее направление обучения</label>
                </div>
                <div className="form-group">
                    ...
                    <label for="program" className="form-label select-label">Выбрать программу</label>
                </div>
                <div className="form-group">
                    <input
                            type="text"
                            ...
                            name="phone"
                    />
                    <label for="phone" className="form-label">Телефон для связи</label>
                </div>
                ...
                <div className="form-action">
                    <button claclassNamess="btn form-button" type="button">
                        Отправить заявку
                    </button>
                </div>
            </form>
